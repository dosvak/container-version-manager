...
* The environment variable value set through `POST .../env_vars` is server state of that snapshot: a re-import of the package restores the
  package value (see the CP4BA rule in `docs/TWX-AUTHORING-NOTES.md`).

## Verification

Lab Process Center 8.6.2 / 20.0.0.1 (<process-center-host>), playback of the dashboard driven by Playwright (`tools/pc_cvmgr_test.py`, 29/29), final package of 2026-09-19:
